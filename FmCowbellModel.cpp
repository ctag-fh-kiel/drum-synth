...
void FmCowbellModel::RenderControls() {
    ImGui::SliderFloat("fbA", &fbA, 200.0f, 1000.0f);
    ImGui::SliderFloat("d_b1", &d_b1, 0.005f, 0.2f);
    ImGui::SliderFloat("db2", &db2, 0.01f, 1.0f);
    ImGui::SliderFloat("fm", &fm, 500.0f, 3000.0f);
    ImGui::SliderFloat("I", &I, 0.0f, 100.0f);
    ImGui::SliderFloat("dm", &dm, 0.01f, 1.0f);
    ImGui::SliderFloat("bm", &bm, 0.0f, 1.0f);
    ImGui::SliderFloat("Ab1", &Ab1, 0.0f, 1.0f);
}
